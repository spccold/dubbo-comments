...
public class RegistryDirectory<T> extends AbstractDirectory<T> implements NotifyListener {
    ...
    public RegistryDirectory(Class<T> serviceType, URL url) {
        ...
        // zookeeper://localhost:2181/com.alibaba.dubbo.registry.RegistryService?application=dubbo-test-consumer
        // &dubbo=2.0.0&group=GroupA&interface=com.geek.dubbo.test.api.UserService&methods=createUser,getUser
        //&pid=1402&revision=1.0.0&side=consumer&timestamp=1446620444619&version=1.0.0
